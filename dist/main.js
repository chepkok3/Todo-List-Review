...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_addRemoveItems_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/addRemoveItems.js */ \"./src/modules/addRemoveItems.js\");\n/* harmony import */ var _modules_createNewItems_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/createNewItems.js */ \"./src/modules/createNewItems.js\");\n// eslint-disable-next-line\n\n\n\nconst listForm = document.querySelector('#todo-form');\nconst taskList = document.querySelector('.task-list');\nconst taskCompleteButton = document.querySelector('#delete-tasks');\nconst addTask = document.querySelector('#list-input');\nlistForm.addEventListener('submit', e => {\n  e.preventDefault();\n  const savedTask = new _modules_addRemoveItems_js__WEBPACK_IMPORTED_MODULE_1__.ItemSaved();\n  savedTask.newItem(addTask.value);\n  listForm.reset();\n});\nfor (let i = 1; i <= _modules_addRemoveItems_js__WEBPACK_IMPORTED_MODULE_1__.list.length; i += 1) {\n  _modules_addRemoveItems_js__WEBPACK_IMPORTED_MODULE_1__.list.forEach(lis => {\n    if (lis.index === i) {\n      (0,_modules_createNewItems_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(lis);\n    }\n  });\n}\n\n// clear all completed tasks\ntaskCompleteButton.addEventListener('click', () => {\n  let dolist = _modules_addRemoveItems_js__WEBPACK_IMPORTED_MODULE_1__.list.filter(element => element.completed === false);\n\n  // code for updating index\n  let i = 1;\n  dolist = dolist.map(element => {\n    element.index = i;\n    i += 1;\n    return element;\n  });\n  taskList.innerHTML = '';\n  dolist.forEach((itemList, index) => {\n    (0,_modules_createNewItems_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(itemList, index + 1);\n  });\n  localStorage.setItem('list', JSON.stringify(dolist));\n});\n\n//# sourceURL=webpack://to-do-ist/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"ItemSaved\": () => (/* binding */ ItemSaved),\n/* harmony export */   \"list\": () => (/* binding */ list)\n/* harmony export */ });\n/* harmony import */ var _createNewItems_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createNewItems.js */ \"./src/modules/createNewItems.js\");\n/* eslint-disable */\n\nlet list = JSON.parse(localStorage.getItem('list')) || [];\nclass ItemSaved {\n  constructor(description, completed = false, index) {\n    this.description = description;\n    this.completed = completed;\n    this.index = index;\n  }\n  newItem(newToDo) {\n    this.description = newToDo;\n    this.index = list.length + 1;\n    list.push({\n      description: this.description,\n      completed: this.completed,\n      index: this.index\n    });\n    localStorage.setItem('list', JSON.stringify(list));\n    (0,_createNewItems_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(this, list.length + 1);\n  }\n\n  // code for removing added task\n  removeTask(index) {\n    list = list.filter(element => element.index !== index);\n    localStorage.setItem('list', JSON.stringify(list));\n    const taskList = document.querySelector('.task-list');\n    taskList.innerHTML = '';\n    this.indexUpdate();\n    this.showlist();\n  }\n\n  // show tasks after deleting\n  showlist = () => {\n    list.forEach((itemObj, index) => {\n      (0,_createNewItems_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(itemObj, index + 1);\n    });\n    localStorage.setItem('list', JSON.stringify(list));\n  };\n\n  //  code for updating index\n  indexUpdate = () => {\n    list = list.map((element, index) => {\n      element.index = index + 1;\n      return element;\n    });\n    localStorage.setItem('list', JSON.stringify(list));\n  };\n\n  // code for editing tasks\n  editItem = (id, text) => {\n    list.forEach(element => {\n      if (element.index === id) {\n        element.description = text;\n      }\n    });\n    localStorage.setItem('list', JSON.stringify(list));\n  };\n}\n\n\n/* eslint-enable */\n\n//# sourceURL=webpack://to-do-ist/./src/modules/addRemoveItems.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst itemCheck = (e, itemList, text, list) => {\n  list[itemList.index - 1].completed = !itemList.completed;\n  if (itemList.completed) {\n    text.style.textDecoration = 'line-through';\n  } else {\n    text.style.textDecoration = 'none';\n  }\n};\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (itemCheck);\n\n//# sourceURL=webpack://to-do-ist/./src/modules/checkBox.js?");

/***/ }),

/***/ "./src/modules/createNewItems.js":
/*!***************************************!*\
  !*** ./src/modules/createNewItems.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _addRemoveItems_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./addRemoveItems.js */ \"./src/modules/addRemoveItems.js\");\n/* harmony import */ var _checkBox_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkBox.js */ \"./src/modules/checkBox.js\");\n/*eslint-disable*/\n\n/* eslint-enable */\n\n\n// create a list of tasks\nconst itemsList = (itemList, id) => {\n  const taskList = document.querySelector('.task-list');\n  const li = document.createElement('li');\n  taskList.appendChild(li);\n  const div = document.createElement('div');\n  div.classList.add('items-container');\n  li.appendChild(div);\n  const checkbox = document.createElement('input');\n  checkbox.setAttribute('type', 'checkbox');\n  checkbox.classList.add('check-item');\n  div.appendChild(checkbox);\n  const text = document.createElement('input');\n  text.setAttribute('type', 'text');\n  text.setAttribute('placeholder', itemList.description);\n  text.setAttribute('disabled', '');\n  div.appendChild(text);\n  const button = document.createElement('button');\n  button.setAttribute('type', 'button');\n  button.innerHTML = `\n    <i class=\"fa fa-ellipsis-vertical\"></i>`;\n  button.addEventListener('click', e => {\n    const itemParent = e.target.parentNode.parentNode;\n    itemParent.querySelector('.fa-trash-can').parentNode.style.display = 'block';\n    li.style.background = '#f7ce';\n    button.style.display = 'none';\n    text.disabled = false;\n    text.focus();\n  });\n  li.appendChild(button);\n  const deleteButton = document.createElement('button');\n  deleteButton.setAttribute('type', 'button');\n  deleteButton.innerHTML = `\n    <i class='fa-solid fa-trash-can'></i>`;\n  deleteButton.style.display = 'none';\n  deleteButton.id = id;\n  deleteButton.addEventListener('click', () => {\n    const deleteItem = new _addRemoveItems_js__WEBPACK_IMPORTED_MODULE_0__.ItemSaved();\n    deleteItem.removeTask(id);\n  });\n  li.appendChild(deleteButton);\n  text.addEventListener('keypress', e => {\n    if (e.key === 'Enter') {\n      text.placeholder = text.value;\n      button.style.display = 'flex';\n      deleteButton.style.display = 'none';\n      text.disabled = true;\n      li.style.background = 'none';\n      const Item = new _addRemoveItems_js__WEBPACK_IMPORTED_MODULE_0__.ItemSaved();\n      Item.editItem(id, text.value);\n    }\n  });\n  if (itemList.completed) {\n    checkbox.checked = true;\n    text.style.textDecoration = 'line-through';\n  }\n  let lis = {};\n  _addRemoveItems_js__WEBPACK_IMPORTED_MODULE_0__.list.forEach(element => {\n    if (element.index === itemList.index) {\n      lis = element;\n    }\n  });\n  checkbox.addEventListener('click', e => {\n    (0,_checkBox_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(e, lis, text, _addRemoveItems_js__WEBPACK_IMPORTED_MODULE_0__.list);\n    localStorage.setItem('list', JSON.stringify(_addRemoveItems_js__WEBPACK_IMPORTED_MODULE_0__.list));\n  });\n};\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (itemsList);\n\n//# sourceURL=webpack://to-do-ist/./src/modules/createNewItems.js?");
